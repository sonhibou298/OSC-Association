...
<div class="container">
    <div class="card mt-5">
        ...
        <div class="card-body">
            <a href="{{route('AjouterEntreprise')}}" class="btn btn-outline-secondary">Ajouter un pays</a><br><br>
            ...
            @foreach($ese as $e)
                    <tr>
                        ...
                        <td>{{$e->registre}}</td>
                        <td>{{$e->minea}}</td>
                        <td>{{$e->disposifFormation}}</td>
                        <td>{{$e->organigramme}}</td>
                        <td>{{$e->contrat}}</td>
                        <td>{{$e->quartier_id}}</td>
                        <td>
                            <a href=""><button type="button" class="btn btn-outline-warning">Modifier</button></a>
                            <a onclick="return confirm('Voulez-vous supprimer ce pays ?')" href="{{route('SupprimerPays')}}" return><button type="button" class="btn btn-outline-danger">Supprimer</button></a>
                        </td>
                    </tr>
                @endforeach
            </table>
